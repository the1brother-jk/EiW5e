...
The DM can write a Letter of Exile for each player, using the following format:
...
These deities were mentioned in Exiled in Wraeclast but not detailed in Player's Handout:
...
**Example:** Kor makes a spell attack with firestrike, which has an ignite threshold of 3. If he rolls 18-20, he will ignite the target. He also casts Frost Bolt, which has a chill threshold of 4. If a creature hit rolls 1-4 on its saving throw, it becomes chilled.
